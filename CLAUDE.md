...
└── jobboard-web/     Nuxt 3 frontend         → jobboard-web/README.md
```
...
- Types mirror the backend DTOs under `types/*.ts`, kept in sync by hand — when a backend DTO shape changes, update the matching frontend type.
