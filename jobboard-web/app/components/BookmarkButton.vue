...
<template>
  <button
    type="button"
    class="rounded-md p-1.5 text-slate-500 hover:bg-slate-100 hover:text-primary-600 disabled:opacity-50 dark:text-slate-400 dark:hover:bg-slate-800"
  ...
  >
    <svg
      ...
      class="h-5 w-5" :class="modelValue ? 'fill-primary-600 stroke-primary-600' : 'fill-none'"
    >
