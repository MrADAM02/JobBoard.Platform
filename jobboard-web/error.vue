...
<template>
  <div class="flex min-h-screen flex-col items-center justify-center gap-4 bg-slate-50 px-4 text-center">
    <p class="text-6xl font-bold text-slate-300">{{ error.statusCode }}</p>
