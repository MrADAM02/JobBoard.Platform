...
<template>
  <div class="relative" @keydown.escape="open = false">
    ...
    <div
      v-if="open"
      role="menu"
      class="absolute end-0 z-20 mt-2 w-72 max-w-[calc(100vw-2rem)] rounded-xl border border-slate-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-900 sm:w-80"
    >
        ...
        >
          <span class="flex items-start gap-2">
            <span
              ...
              :class="notification.isRead ? 'bg-transparent' : 'bg-primary-500'"
            />
